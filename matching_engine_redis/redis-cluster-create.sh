...
node_3_ip=$(getent hosts matching_engine_redis_3 | awk '{ print $1 }')
node_4_ip=$(getent hosts matching_engine_redis_4 | awk '{ print $1 }')
node_5_ip=$(getent hosts matching_engine_redis_5 | awk '{ print $1 }')
